from api_testing_framework.src.models.booking_model import BookingData
from api_testing_framework.src.request_objects.delete_booking_request import DeleteBookingRequest

class BookingFactory:
    @staticmethod
    def create_default_booking() -> BookingData:
        return BookingData(
            firstname="Jim",
            lastname="Brown",
            totalprice=111,
    ...
    @staticmethod
    def create_updated_booking() -> BookingData:
        return BookingData(
            firstname="James",
            lastname="Brown",
            totalprice=115,
    ...
    @staticmethod
    def create_e2e_default_booking() -> BookingData:
        return BookingData(
            firstname="E2E_Jim",
            lastname="E2E_Brown",
            totalprice=222,
    ...
    @staticmethod
    def create_e2e_updated_booking() -> BookingData:
        return BookingData(
            firstname="E2E_James",
            lastname="E2E_Brown",
            totalprice=225,
